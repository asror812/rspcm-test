...
public class UserMapper {
    ...
    public static User toEntity(UserCreateRequest request, String encodedPassword, Set<Role> roles) {
        return User.builder()
    ...
    public static void updateEntity(User user, UserUpdateRequest request, Set<Role> roles) {
